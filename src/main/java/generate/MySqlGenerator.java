...
//        strategyConfig.setCapitalMode(true);    // 全局大写命名 ORACLE 注意
        ...
        strategyConfig.setInclude(new String[] { "customer", "bank" }); // 需要生成的表
        // strategy.setExclude(new String[]{"test"}); // 排除生成的表
        // 自定义实体父类
        strategyConfig.setSuperEntityClass("com.example.demo.Entity");
        // 自定义实体，公共字段
        // strategy.setSuperEntityColumns(new String[] { "test_id", "age" });
        // 自定义 mapper 父类
        // strategy.setSuperMapperClass("com.baomidou.demo.TestMapper");
        // 自定义 service 父类
        strategyConfig.setSuperServiceClass("com.example.demo.service");
        // 自定义 service 实现类父类
        // strategy.setSuperServiceImplClass("com.baomidou.demo.TestServiceImpl");
        // 自定义 controller 父类
        strategyConfig.setSuperControllerClass("com.example.demo.controller");
